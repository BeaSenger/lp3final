...
import Auxiliar.*;
// @author Radames
public class VeiculoGUIListagem extends JDialog {

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"Codigo","Nome","Veiculo.txt"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public VeiculoGUIListagem(List<String> texto, Container cp2) {
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Codigo","Nome","Veiculo.txt"}, 0);
        int aux = 0;
